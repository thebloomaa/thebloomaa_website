...
export const BLOOMAA_PRODUCTS = {
  ...
  JUST_BLOOMED_TRIAL: {
    ...
    type: 'TRIAL_PLAN',
    price: 451,
    description: '7 unique totally raw/living boxes mapped to 7 daily cellular goals. Delivered fresh every morning in Patna.',
    calories: 420, protein: 22, carbs: 48, fats: 16,
    dietaryPreference: 'LIVING_RAW',
    imageUrl: '/meals/vegan-keto.png',
    isTrialPlan: true,
    logisticsNote: '7-DAY TRIAL: Delivered fresh every morning between 6:00 AM – 9:00 AM in Patna.',
    trialBoxes: JUST_BLOOMED_BOXES,
  },
  MONTHLY_SUBSCRIPTION: {
    id: 'prod-monthly-living-diet',
    name: '30-Day Monthly Living Diet Plan',
    type: 'SUBSCRIPTION_PLAN',
    price: 0,
    description: '30-day complete living food transformation. Rotating chef bowls delivered fresh every morning 6:00 AM – 9:00 AM in Patna.',
    calories: 420, protein: 22, carbs: 48, fats: 16,
    dietaryPreference: 'LIVING_RAW',
    imageUrl: '/meals/vegan-keto.png',
    logisticsNote: '30-DAY MONTHLY PLAN: Delivered every morning between 6:00 AM – 9:00 AM in Patna.',
  },
  LEAN_MUSCLE: {
