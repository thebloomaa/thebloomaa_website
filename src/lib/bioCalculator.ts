...
export const BLOOMAA_PRODUCTS = {
  ...
  LEAN_MUSCLE: {
    ...
    type: 'MEAL_PLAN',
    price: 350,
    description: 'Sprouted organic moong, edamame, roasted organic tofu cubes, fluffy tri-color quinoa, and steamed crunchy broccoli with almond crunch. 100% pure veg & bio-available plant protein.',
    calories: 620,
    protein: 48,
    carbs: 48,
    fats: 16,
