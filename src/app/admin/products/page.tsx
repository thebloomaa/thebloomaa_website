    ...
    <div className="max-w-5xl mx-auto">
      ...
      {showForm && (
        <div className="rounded-2xl p-6 mb-6 animate-fade-in-up" style={{ background: 'var(--bg-card)', border: '1px solid var(--border-subtle)' }}>
          ...
          <button onClick={handleAdd} disabled={!form.name || !form.price} className="px-6 py-2.5 rounded-xl text-sm font-bold text-white shadow-sm disabled:opacity-40" style={{ background: 'var(--brand-primary)' }}>
            Save Product
          </button>
        </div>
      )}
