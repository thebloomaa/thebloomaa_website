        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="space-y-6 text-sm text-brand-forest-muted leading-relaxed">
            <section className="space-y-2">
              <h2 className="text-base font-bold text-brand-forest">1. Information We Collect</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-bold text-brand-forest">2. How We Use Your Data</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-bold text-brand-forest">3. Payment &amp; UPI Security</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-bold text-brand-forest">5. Contacting Us</h2>
              <p>
